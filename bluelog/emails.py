...
def send_mail(subject, to, html):
    app = current_app._get_current_object()     # current_app is proxy; `._get_current_object()` to get real app instance.
...
def send_new_comment_email(post):
    ...
    send_mail(subject='New comment', to=current_app.config['ADMIN_EMAIL'],
